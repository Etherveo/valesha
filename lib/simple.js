          ...
          : PATH instanceof ArrayBuffer
            ...
            : /^data:.*?\/.*?;base64,/i.test(PATH)
              ...
              : /^https?:\/\//.test(PATH)
                ...
                // ? await (res = await fetch(PATH)).buffer() // PREV-LEGACY
                : fs.existsSync(PATH)
          ...
          jid,
          {
            ...
            contextInfo: {
              ...
              forwardedNewsletterMessageInfo: {
                newsletterJid: "120363408317446210@newsletter",
                serverMessageId: null,
                newsletterName: "⌜ Yue Arifureta ⌟",
              },
              externalAdReply: {
      ...
      ? {
          chatRead: {
            ...
            value(jid, participant = conn.user.jid, messageID) {
              return conn.readMessages(jid, participant, [messageID]);
            },
            enumerable: true,
          },
        }
            ...
            download: {
              value(saveToFile = false) {
                ...
                return self.conn?.downloadM(
                  ...
                  this.message.viewOnceMessageV2Extension?.message?.[mtype] ||
                  this.message.documentWithCaptionMessage?.message?.[mtype] ||
                  this.header[mtype],
